...
if ($_GET) {
	...
	<?php
	$n0ticefeed_url="http://feedwax.com/feeders/googlespreadsheetsfeeder.php?spreadsheet_url=".urlencode($_GET['spreadsheet_url'])."&title=".urlencode($_GET['title'])."&description=".urlencode($_GET['description']);
